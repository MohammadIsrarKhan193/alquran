...
function loadHijri() {
    const ev = [
        { title: "27 Rajab", date: "16 Jan, 2026", img: "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=200" },
        { title: "1 Ramadan", date: "18 Feb, 2026", img: "https://images.unsplash.com/photo-1564769662533-4f00a87b4056?w=200" },
        { title: "Eid ul Fitr", date: "20 Mar, 2026", img: "https://images.unsplash.com/photo-1519810755548-39cd217da494?w=200" }
    ];
    document.getElementById('hijri-list').innerHTML = ev.map(e => `
